  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      if (result.nitrogenLevel == 'Low') _RecCard(
        ...
        body: 'Apply Urea (46-0-0) at 100–200 kg/ha; or Ammonium Sulfate (21-0-0) for acidic soils. Supplement with compost or vermicast. Consider growing nitrogen-fixing legumes (Mungbean, Peanut) as intercrop.',
      ),
      if (result.phosphorusLevel == 'Low') _RecCard(
        color: SoilColors.medium,
        icon: Icons.water_drop_outlined,
        title: s.tr('phosphorus_deficiency'),
        body: 'Apply Triple Superphosphate – TSP (0-46-0) at 100–150 kg/ha, or Single Superphosphate for acidic soils. Bone meal is a good organic alternative. Target pH 6.0–7.0 for maximum phosphorus availability.',
      ),
      if (result.potassiumLevel == 'Low') _RecCard(
        color: SoilColors.clay,
        icon: Icons.eco_outlined,
        title: s.tr('potassium_deficiency'),
        body: 'Apply Muriate of Potash – MOP (0-0-60) at 50–100 kg/ha. Wood ash is an effective organic alternative. Ensure adequate soil moisture for proper potassium uptake.',
      ),
      if (result.ph >= 5.5 && result.ph < 6.0) _RecCard(
        color: const Color(0xFF7A5C9A),
        icon: Icons.science_outlined,
        title: '${s.tr('acidic_soil')} (pH ${result.ph})',
        body: 'Moderately acidic soil. Apply dolomite (agricultural lime) at 0.5–1 tonne/ha to raise pH to the optimal range. Retest after 3–4 months.',
      ),
      if (result.ph < 5.5) _RecCard(
        color: const Color(0xFF7A5C9A),
        icon: Icons.science_outlined,
        title: '⚠️ ${s.tr('acidic_soil')} (pH ${result.ph})',
        body: 'Strongly acidic soil detected. Apply dolomite (CaMg(CO₃)₂) at 1–2 tonnes/ha to correct acidity. Dolomite also supplies calcium and magnesium. Avoid Ammonium Sulfate fertilizers — use Urea instead. Retest after 3–4 months.',
      ),
      ...
      if (result.nitrogenLevel == 'High' &&
          ...
          result.ph >= 6.0 && result.ph <= 7.0)
        _RecCard(
          color: SoilColors.high,
          icon: Icons.check_circle_outline_rounded,
          title: s.tr('all_good'),
          body: 'Soil NPK and pH are well-balanced. Maintain fertility with regular organic matter (compost or vermicast). Monitor every cropping season to prevent nutrient build-up or over-fertilization.',
        ),
